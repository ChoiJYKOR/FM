...
export const chapter0: Chapter = {
  ...
  images: [
    {
      urls: [
        "https://res.cloudinary.com/dcjij84tc/image/upload/v1767529658/why_fuse_kbcocl.jpg",
      ],
      sections: [
        {
          title: "왜 퓨즈인가?",
    ...
    {
      urls: [
        "https://res.cloudinary.com/dcjij84tc/image/upload/v1767525333/%EC%9D%BC%EC%A0%95%ED%91%9C_nzsygd.png",
      ],
      sections: [
        {
          title: "프로젝트 배경",
          description: [
            ...
            "프로젝트 기간: 12일",
            "참여인원: 9명",
            "상황 설정: 가정용 로봇과 전기차의 대량 보급에 대비하기 위해 FM(퓨즈는 못말려)사는 퓨즈 검수공정 고도화 프로젝트팀을 조직함.",
          ],
        },
        {
          title: "프로젝트 개요",
    ...
    },
    {
      urls: ["/images/PP/PP_01.webp",
        ...
        "https://res.cloudinary.com/dcjij84tc/image/upload/v1767526873/inverter_xz6w1s.jpg",
        "https://res.cloudinary.com/dcjij84tc/image/upload/v1767526723/cclink_ukts4g.png",
      ],
      sections: [
        {
          title: "활용 장비",
